...
public class HttpRequestClientFactory {
    ...
    public static FilterableRequestSpecification initReqSpec() {
        FilterableRequestSpecification filterableRequestSpecification = (FilterableRequestSpecification) createAllureFilterReqSpec()
    ...
    private static FilterableRequestSpecification createAllureFilterReqSpec() {
